...
class BertImgModel(BertPreTrainedModel):
    ...
    def forward(self, input_ids, token_type_ids=None, attention_mask=None,
            ...
            encoder_history_states=None, topk_embed_knowledge=None):
        ...
        if topk_embed_knowledge is not None:
            embedding_output = torch.cat((embedding_output, topk_embed_knowledge), 1)
